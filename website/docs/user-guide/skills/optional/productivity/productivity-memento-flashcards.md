...
```
${HERMES_HOME:-${MENTE_HOME:-$HOME/.mente}}/skills/productivity/memento-flashcards/data/cards.json
```
...
```bash
MEMENTO_ROOT="${HERMES_HOME:-${MENTE_HOME:-$HOME/.mente}}/skills/productivity/memento-flashcards"
python3 "$MEMENTO_ROOT/scripts/memento_cards.py" add \
...
```bash
MEMENTO_ROOT="${HERMES_HOME:-${MENTE_HOME:-$HOME/.mente}}/skills/productivity/memento-flashcards"
python3 "$MEMENTO_ROOT/scripts/memento_cards.py" due
```

This returns a JSON array of cards where `next_review_at <= now`. If a collection filter is needed:

```bash
python3 "$MEMENTO_ROOT/scripts/memento_cards.py" due --collection "History"
```
...
```bash
python3 "$MEMENTO_ROOT/scripts/memento_cards.py" rate \
...
```bash
MEMENTO_ROOT="${HERMES_HOME:-${MENTE_HOME:-$HOME/.mente}}/skills/productivity/memento-flashcards"
python3 "$MEMENTO_ROOT/scripts/youtube_quiz.py" fetch VIDEO_ID
```
...
```bash
python3 "$MEMENTO_ROOT/scripts/memento_cards.py" add-quiz \
  --video-id "VIDEO_ID" \
...
```bash
MEMENTO_ROOT="${HERMES_HOME:-${MENTE_HOME:-$HOME/.mente}}/skills/productivity/memento-flashcards"
python3 "$MEMENTO_ROOT/scripts/memento_cards.py" export \
...
```bash
MEMENTO_ROOT="${HERMES_HOME:-${MENTE_HOME:-$HOME/.mente}}/skills/productivity/memento-flashcards"
python3 "$MEMENTO_ROOT/scripts/memento_cards.py" import \
  --file ~/flashcards.csv \
  --collection "Imported"
```
...
```bash
MEMENTO_ROOT="${HERMES_HOME:-${MENTE_HOME:-$HOME/.mente}}/skills/productivity/memento-flashcards"
python3 "$MEMENTO_ROOT/scripts/memento_cards.py" stats
```
...
MEMENTO_ROOT="${HERMES_HOME:-${MENTE_HOME:-$HOME/.mente}}/skills/productivity/memento-flashcards"
python3 "$MEMENTO_ROOT/scripts/memento_cards.py" stats
python3 "$MEMENTO_ROOT/scripts/memento_cards.py" add --question "Capital of France?" --answer "Paris" --collection "General"
python3 "$MEMENTO_ROOT/scripts/memento_cards.py" due
```
