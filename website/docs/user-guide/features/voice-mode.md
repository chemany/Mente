...
sidebar_position: 10
title: "Voice Mode"
description: "Real-time voice conversations with Mente — CLI, Telegram, Discord (DMs, text channels, and voice channels)"
---

# Voice Mode

Mente supports full voice interaction across CLI and messaging platforms. Talk to the agent using your microphone, hear spoken replies, and have live voice conversations in Discord voice channels.
...
1. **Mente installed** — `pip install hermes-agent` (see [Installation](/getting-started/installation))
