...
description: "Connect Mente to external tool servers via MCP — and control exactly which MCP tools Mente loads"
---

# MCP (Model Context Protocol)

MCP lets Mente connect to external tool servers so the agent can use tools that live outside Mente itself — GitHub, databases, file systems, browser stacks, internal APIs, and more.
