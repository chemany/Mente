...
| [`plan`](/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write markdown plan to .mente/plans/, no exec. | `software-development/plan` |
