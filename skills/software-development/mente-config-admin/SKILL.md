---
name: mente-config-admin
description: Use when the user asks Mente to change API keys, OAuth/provider auth, config.yaml or .env settings, gateway/platform credentials, or restart/reload services after configuration changes.
version: 1.0.0
author: Mente
license: MIT
metadata:
  hermes:
    ...
    related_skills: [hermes-agent, systematic-debugging, verification-before-completion]
---
