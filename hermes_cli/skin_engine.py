...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Mente Agent"           # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Mente "        # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Mente Agent"
...
- ``default`` — Classic Mente gold/kawaii (the current look)
