...
def format_banner_version_label() -> str:
    ...
    agent_name = _skin_branding("agent_name", "Mente Agent")
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    accent = _skin_color("banner_accent", "#43C7C4")
    dim = _skin_color("banner_dim", "#6C8A90")
    text = _skin_color("banner_text", "#D9E8E9")
    session_color = _skin_color("session_border", "#5C7378")
    ...
    agent_name = _skin_branding("agent_name", "Mente Agent")
    title_color = _skin_color("banner_title", "#7CE8D8")
    border_color = _skin_color("banner_border", "#315A61")
    ...
    if term_width >= 95:
        _logo = _bskin.banner_logo if _bskin and hasattr(_bskin, 'banner_logo') and _bskin.banner_logo else MENTE_AGENT_LOGO
        console.print(_logo)
        console.print()
