...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateHermes: "Update Mente",
    updatingHermes: "Updating Mente...",
  ...
  tasks: {
    ...
    sessionPlaceholder: "Paste a session id for session scope",
    taskType: "Task Type",
    taskTypePlaceholder: "e.g. cron, gateway_message",
    applyFilters: "Apply",
    resetFilters: "Reset",
    returned: "Returned",
    offset: "Offset",
  ...
  agents: {
    ...
    agentsWithStateDb: "Agents With State DB",
    agentsWithLogDb: "Agents With Log DB",
    ...
    fullSoul: "Full Soul",
    noSoul: "No soul content found.",
    resetRuntime: "Reset Context",
    resettingRuntime: "Resetting",
    clearRuntime: "Clear Runtime",
    clearingRuntime: "Clearing",
    runtimeResetSuccess: "Runtime context reset, removed entries",
    runtimeClearSuccess: "Runtime cleared, removed entries",
    failedToLoad: "Failed to load agent inventory",
    failedToLoadDetail: "Failed to load agent detail",
    confirmReset: "Reset this agent's execution context?",
    confirmClear: "Clear all runtime contents for this agent?",
  },
  ...
  memories: {
    ...
    sessionPlaceholder: "Paste a session id for session scope",
    taskType: "Task Type",
    taskTypePlaceholder: "e.g. conversation, cron",
    applyFilters: "Apply",
    resetFilters: "Reset",
    returned: "Returned",
    offset: "Offset",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.mente/skills/",
